@extends('layouts.app', ['title' => 'Edit Posisi'])
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.positions.index') }}">Master posisi</a>
                        </li>
                        <li class="breadcrumb-item" aria-current="page">Edit posisi</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <form action="{{ route('admin.positions.update', encrypt($position->id)) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="position" class="form-control @error('position') is-invalid @enderror "
                                placeholder="Ketik disini..." name="position" value="{{ $position->position_name }}">
                            @error('position')
                        ...
                        <div class="mb-3">
                            ...
                            <select name="isQrpEnabled" id="isQrpEnabled" class="form-select">
