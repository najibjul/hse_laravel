@extends('layouts.app', ['title' => 'Edit Plant'])
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Edit plant</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12 col-lg-9">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.plants.update', encrypt($plant->id)) }}" method="POST">
                        @method('PATCH')
                        @csrf
                        <div class="mb-3">

                            <label for="plant">Nama plant</label>
                            <input type="text" id="plant" class="form-control @error('plant') is-invalid @enderror "
                                placeholder="Ketik disini ..." name="plant" value="{{ $plant->plant_name }}">
                            @error('plant')
