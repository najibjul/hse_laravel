            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.departments.index') }}">Master Department</a></li>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" class="form-control @error('department_name') is-invalid @enderror "
                            placeholder="Masukan nama..." name="department_name" required value="{{ old('department_name') }}">
