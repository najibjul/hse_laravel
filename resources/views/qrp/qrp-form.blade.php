        ...
        <form method="POST" action="{{ route('qrp.qrp-form-post') }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group mb-4">
                    ...
                    <input type="text" class="form-control" disabled value="{{ strtoupper(session('checkingCategory')) }}">
                </div>
                <div class="form-group mb-4">
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea name="description" id="description" oninput="autoGrowDescription(this)"
                        class="form-control @error('description') is-invalid @enderror" placeholder="ketik disini"
                ...
                <div class="form-group mb-4">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="direct-tab" data-bs-toggle="tab" data-bs-target="#direct"
                                type="button" role="tab" aria-controls="direct" aria-selected="true">Foto langsung</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="galeri-tab" data-bs-toggle="tab" data-bs-target="#galeri"
                                type="button" role="tab" aria-controls="galeri" aria-selected="false">Dari Galeri</button>
                        </li>
                    </ul>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea name="recomendation" id="recomendation" oninput="autoGrowRecomendation(this)"
                            class="form-control @error('recomendation') is-invalid @enderror" placeholder="ketik disini"
                            required>{{ old('recomendation') }}</textarea>
                        @error('recomendation')
                            <div class="form-text text-danger mb-3">{{ $message }}</div>
                        @enderror
                    </div>
