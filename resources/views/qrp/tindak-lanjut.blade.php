@extends('layouts.app', ['title' => 'Foto tindak lanjut'])
@section('content')
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content py-4 px-3" id="nav-tabContent">
                        <div class="tab-pane fade show active text-center" id="nav-live" role="tabpanel"
                            ...
                            <form method="POST" action="{{ route('qrp.tindak-lanjut-live', $dailyCheck->id) }}">
                                @csrf
                                @method('put')
                        ...
                        <div class="tab-pane fade" id="nav-galery" role="tabpanel" aria-labelledby="nav-galery-tab">
                            <form method="POST" action="{{ route('qrp.tindak-lanjut-gallery', $dailyCheck->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
