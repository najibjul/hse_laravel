            ...
            <div class="my-2 d-flex justify-content-between">
                ...
                <div class="d-none d-md-block">
                    <div class="d-flex justify-content-center gap-3">
                        ...
                        <?php endif; ?>
                        <form id="form-export" action="<?php echo e(route('qrp.show-export', $dailyCheck->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <form action="<?php echo e(route('rise-up', $dailyCheck->id)); ?>" method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <div>Rise up ke <b><i><?php echo e(auth()->user()->leader?->name); ?>
...
<?php echo $__env->make('layouts.app', ['title' => 'Detail laporan'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\hse_laravel\resources\views/qrp/qrp-form-detail.blade.php ENDPATH**/ ?>